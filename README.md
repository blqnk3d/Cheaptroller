...
| **Custom Layout**                                                                                                                                                                                                                       | <img src="assets/CustomLayout.jpg" alt="Custom Layout" width="700">                  |
| The editor allows you to create a custom controller layout by placing buttons and joysticks anywhere on the screen. This gives you full control over the button arrangement to suit your specific needs.                                        |
